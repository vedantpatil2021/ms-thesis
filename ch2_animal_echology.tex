%% ============================================================
%% chapters/chapter2_smartwilds.tex
%% Chapter 2: SmartWilds — Proactive Far-Edge AI Design for
...
Those observations drove the design. My role in SmartWilds was the design and deployment of the autonomous drone coordination system, which meant translating what The Wilds revealed about the problem into a system architecture that could solve it. The inflection-point principles from Chapter 2 informed every infrastructure decision: offline-first from the start, no runtime network dependency at any layer, self-sufficient on the hardware it would be carried to.
...
Table 3.2 lists all eight services, their ports, ownership, and roles.
...
\label{subsec:ch2_openpasslite_additions}
...
\label{sec:ch2_principles_applied}
%% ============================================================
