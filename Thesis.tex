...
\author{Vedant Patil}
\title{Resilient Far-Edge AI: Characterizing Deployment Failures\\[0.3em]
and Designing Offline-First Systems for Real-World Environments}
\authordegrees{M.S.}  % Degrees thus far, not including this one.
\unit{Department of Computer Science and Engineering}

\advisorname{Dr. Christopher Stewart}
\member{Dr. Hari Subramoni}
...
\dedication{This is dedicated to the one I love \ldots\ Aai, Baba and Sarthak \ldots}
...
\include{intro}       % intro
\include{background_and_Related_Work}
\include{dummychap1}     % tell them what you are going to tell them
% \include{ch1_digi_ag}     % tell them what you are going to tell them 
\include{ch2_animal_echology}   % describe the problem statement
\include{conclusion}    % what is your solution
